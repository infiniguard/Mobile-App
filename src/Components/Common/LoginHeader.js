...
export default class LoginHeader extends PureComponent{
    ...
    async navigateToScreen(route){
        if(route=='ContactScreen'){
            this.setState({sideMenu:false},()=>Linking.openURL('https://www.infiniguard.com/contact'))
        }
    ...
    render(){
        return(
            <>
                <LinearGradient colors={this.state.loggedIn?colors.loginGradient:colors.logoutGradient} style={styles.container}>
                    <StatusBar backgroundColor={this.state.loggedIn?colors.loginPrimary:colors.logoutPrimary} barStyle={'light-content'} />
                ...
                >
                    <View style={[styles.container2,(this.state.name != "" ? styles.logged : styles.login )]}>
                        <View style={{flexDirection:'row'}}>
                            <View style={{ marginTop:'10%', width:'65%',marginLeft:'5%',alignSelf: 'flex-start',}}>
                                <TouchableOpacity activeOpacity={0.7} onPress={()=>this.setState({sideMenu:false})}>
                        ...
                        {this.state.name != "" ?
                            <View style={[styles.navBorderStyle,(this.state.currentScreen === 'ScanQRCodeScreen' ? styles.navactive : {} )]} >
                                <Text allowFontScaling={false} style={[styles.navItemStyle,(this.state.currentScreen === 'ScanQRCodeScreen' ? styles.textactive : {} )]} onPress={()=>this.navigateToScreen('ScanQRCodeScreen')}>
                        ...
                        <View style={[styles.navBorderStyle,(this.state.currentScreen === 'MaintenanceScreen' ? styles.navactive : {} )]} >
                            <Text allowFontScaling={false} style={[styles.navItemStyle,(this.state.currentScreen === 'MaintenanceScreen' ? styles.textactive : {} )]} onPress={()=>this.navigateToScreen('MaintenanceScreen')}>
                                {I18n.t('Side_Menu.maintenance')}
                            </Text>
                        </View>
                        <View style={[styles.navBorderStyle,(this.state.currentScreen === 'WarrantyScreen' ? styles.navactive : {} )]} >
                            <Text allowFontScaling={false} style={[styles.navItemStyle,(this.state.currentScreen === 'WarrantyScreen' ? styles.textactive : {} )]} onPress={()=>this.navigateToScreen('WarrantyScreen')}>
                                {I18n.t('Side_Menu.warranty')}
                            </Text>
                        </View>
                        <View style={[styles.navBorderStyle,(this.state.currentScreen === 'ContactScreen' ? styles.navactive : {} )]} >
                            <Text allowFontScaling={false} style={[styles.navItemStyle,(this.state.currentScreen === 'ContactScreen' ? styles.textactive : {} )]} onPress={()=>this.navigateToScreen('ContactScreen')}>
                                {I18n.t('Side_Menu.contact')}
                            </Text>
                        </View>
                        <View style={[styles.navBorderStyle,(this.state.currentScreen === 'SelectLang' ? styles.navactive : {} )]} >
                            <Text allowFontScaling={false} style={[styles.navItemStyle,(this.state.currentScreen === 'SelectLang' ? styles.textactive : {} )]} onPress={()=>this.buttonCallback()}>
                                {this.state.lang}
                            </Text>
                        </View>
                        {this.state.name != "" ?
                            <View style={[styles.navBorderStyle,(this.state.currentScreen === 'LogoutScreen' ? styles.navactive : {} )]} >
                                <Text allowFontScaling={false} style={[styles.navItemStyle,(this.state.currentScreen === 'LogoutScreen' ? styles.textactive : {} )]} onPress={()=>this.navigateToScreen('Logout')}>
